...
static const int systraypinningfailfirst = 1;  /* 1: if pinning fails, display systray on the first monitor, 0: on the last monitor*/
...
static const char *fonts[] = { 
	"MesloLGS Nerd Font Mono:size=16:antialias=true:autohint=true:hintstyle=hintfull",
...
static const char *dmenucmd[] = { 
	"dmenu_run_desktop", "-p", "Menu:", "-l", "20", "-x", "880", "-y", "32", "-z", "800", "-fn", "mono:size=16", NULL
};
